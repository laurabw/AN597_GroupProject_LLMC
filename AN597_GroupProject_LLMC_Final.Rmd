...
Let do a little exercise to see how *QDA* can be applied to our simplified Kamilar and Cooper dataset and how it differs from *LDA*.
...
```
Another way we can visualize the variation in our data is using the scatterplotMatrix() wrapper function from the *car* package.
```{r}
